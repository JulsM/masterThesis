    ...
    <body>
	    <div id="main">
	  		...
	  		if(!$redirect) {
				...
				<p><strong>Wichtig:</strong> Keine Passwörter oder ähnliche sensible Daten werden gespeichert. Diese Daten lassen keine Rückschlüsse auf andere Athleten zu. Generell werden die Ergebnisse der Studie ausschließlich in anonymisierter und aggregierter Form publiziert, die keinerlei Rückschlüsse auf einzelne Individuen zulassen. Personenbezogene Daten werden nach Abschluss der Studie gelöscht.</p>
